...
to project_x 
  repeat 3 [ show gpio:pwm-set-level 5 18  wait .4 show gpio:pwm-set-level 5 50 wait .2 ]  

 repeat 3 [ show gpio:pwm-set-level 6 18 wait .1 show gpio:pwm-set-level 6 50 wait .1 ] 
end 
...
to project3
 repeat 3 
   [
     show gpio:pwm-set-level 5 40 wait .25  
     show gpio:pwm-set-level 6 30 wait .25
     show gpio:pwm-set-level 5 20 wait .25
     show gpio:pwm-set-level 6 10 wait .25
...
273
NIL
repeat 10 [ show gpio:pwm-set-level 6 16  wait .9 show gpio:pwm-set-level 6 50 wait .5 ]\nshow gpio:pwm-rest 6
NIL
1
T
OBSERVER
